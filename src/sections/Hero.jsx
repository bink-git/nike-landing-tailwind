  ...
  return (
    ...
    >
      <div className="max-xl:padding-x relative flex w-full flex-col items-start justify-center pt-28 xl:w-2/5">
        ...
        <h1 className="relative z-10 mt-10 pr-4 font-palanquin text-8xl font-bold max-sm:text-[72px] max-sm:leading-[82px] xl:whitespace-nowrap xl:bg-white">
          <span className=" pr-10 ">The New Arrival</span>
          <br />
